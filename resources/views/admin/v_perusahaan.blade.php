                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                              <p>File Dokumen  : <a href="{{ route('perusahaan.perusahaan.downloadakta', $perusahaans->id_perusahaan) }}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
