                    ...
                    <div class="modal-dialog" style="width:auto">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <center>
                              <div style="position:relative"><h4><span class="badge badge-success">Foto Depan Kantor</span></h4>
                              </div> 
                                <img class="img-thumbnail" src="{{asset('/verifikasi/fotokantor/fotodepan/'.$perusahaans->fotodepan)}}" style="display:block" width="150px" height="150px"  alt="...">
                              </center>
                                <a style="position: absolute; top:18%;left:46%" href="{{asset('verifikasi/fotokantor/fotodepan/'.$perusahaans->fotodepan)}}" download> <button type="button" class="btn btn-outline-secondary"><i class="fa fa-download"></i></button></a>
                             
                              <div class="row">
                                @if($perusahaans->fotokiri<>null)
                                <div style="position: relative"  class="col-md-6"><h4><span class="badge badge-success" style="display: flex">Foto Kiri Kantor</span></h4>
                                  <center>
                                  <img class="img-thumbnail" src="{{asset('verifikasi/fotokantor/fotokiri/'.$perusahaans->fotokiri)}}" style="display:block;margin:auto" width="150px" height="150px" alt="...">
                                  <a style="position: absolute; top:50%;left:42%" href="{{asset('verifikasi/fotokantor/fotokiri/'.$perusahaans->fotokiri)}}" download> <button type="button" class="btn btn-outline-secondary"><i class="fa fa-download"></i></button></a>
                                </div>
                                @else
                                <div style="position: relative"  class="col-md-6"><h4><span class="badge badge-success" style="display: flex">Foto Kiri Kantor</span></h4>
                                  <center>
                                ...
                                <div style="position: relative;" class="col-md-6"><h4><span class="badge badge-success" style="display: flex" >Foto Kanan Kantor</span></h4>
                                  <center>
                                  <img class="img-thumbnail" src="{{asset('verifikasi/fotokantor/fotokanan/'.$perusahaans->fotokanan)}}"  style="display:block;margin:auto" width="150px" height="150px" alt="...">
                                  <a style="position: absolute; top:50%;left:42%" href="{{asset('verifikasi/fotokantor/fotokanan/'.$perusahaans->fotokanan)}}" download> <button type="button" class="btn btn-outline-secondary"><i class="fa fa-download"></i></button></a>
                                </div>
                                @else
                                <div style="position: relative"  class="col-md-6"><h4><span class="badge badge-success" style="display: flex">Foto Kanan Kantor</span></h4>
                                  <center>
                                  <i style="display: block" class="fa fa-image fa-6x"></i>
                                  <small>Tidak Ada Gambar</small>
                                </div>
                                @endif

                                @if($perusahaans->fotobelakang<>null)
                                <div style="position: relative" class="col-md-6"><h4><span class="badge badge-success">Foto Belakang Kantor</span></h4>
                                  <center>
                                  <img class="img-thumbnail" src="{{asset('verifikasi/fotokantor/fotobelakang/'.$perusahaans->fotobelakang)}}" style="display:block;margin:auto" width="150px" height="150px" alt="...">
                                  <a style="position: absolute; top:50%;left:42%" href="{{asset('verifikasi/fotokantor/fotobelakang/'.$perusahaans->fotobelakang)}}" download> <button type="button" class="btn btn-outline-secondary"><i class="fa fa-download"></i></button></a>
                                </div>
                                @else
                                <div style="position: relative"  class="col-md-6"><h4><span class="badge badge-success" style="display: flex">Foto Belakang Kantor</span></h4>
                                  <center>
                                  <i style="display: block" class="fa fa-image fa-6x"></i>
                                  <small>Tidak Ada Gambar</small>
                                </div>
                                ...
                                <div style="position: relative" class="col-md-6"><h4><span class="badge badge-success" style="display: flex">Foto Dalam Kantor</span></h4>
                                 <center> 
                                  <img class="img-thumbnail" src="{{asset('verifikasi/fotokantor/fotodalam/'.$perusahaans->fotodalam)}}" width="150px" height="150px" alt="...">
                                  <a style="position: absolute; top:50%;left:42%" href="{{asset('verifikasi/fotokantor/fotodalam/'.$perusahaans->fotodalam)}}" download> <button type="button" class="btn btn-outline-secondary"><i class="fa fa-download"></i></button></a>
                                </div>
                                @else
                                <div style="position: relative"  class="col-md-6"><h4><span class="badge badge-success" style="display: flex">Foto Dalam Kantor</span></h4>
                                  <center>
