                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="name" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Nama Lengkap">
                      </div>
                      <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Email">
                      </div>
                      <div class="mb-3">
                        <label for="password" class="form-label">Password</label>
                        <input type="password" class="form-control" id="formGroupExampleInput3" placeholder="Masukkan Password">
                      </div>
                      <div class="mb-3">
                        <label for="password-confirm" class="form-label">Konfirmasi Password</label>
                        <input type="password" class="form-control" id="formGroupExampleInput4" placeholder="Masukkan Password">
                      </div>
                      <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                          ...
                          <input type="text" class="form-control" placeholder="Jenis Kelamin" aria-label="jeniskelamin">
                        </div>
                      </div>
                      <br>
                      <div class="mb-3">
                        <label for="ttl" class="form-label">TTL</label>
                        <input type="ttl" class="form-control" id="formGroupExampleInput5" placeholder="Masukkan Tempat Tanggal Lahir">
                      </div>
                      <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat</label>
                        <input type="alamat" class="form-control" id="formGroupExampleInput6" placeholder="Masukkan Alamat">
                      </div>
                      <div class="mb-3">
                        <!-- Upload image input-->
